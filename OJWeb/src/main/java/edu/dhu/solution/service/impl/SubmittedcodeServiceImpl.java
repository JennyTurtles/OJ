...
//		this.wrongcasesDao = wrongcasesDao;
//	}
...
//
//
//	public StudentTrainCatDetailDaoI getStudentTrainCatDetailDao() {
//		return studentTrainCatDetailDao;
//	}

//	@Autowired
//	public void setStudentTrainCatDetailDao(StudentTrainCatDetailDaoI studentTrainCatDetailDao) {
//		this.studentTrainCatDetailDao = studentTrainCatDetailDao;
//	}
...
//
//			logger.info("用户ID为: " + solution.getUserid() + "exam ID为:"
//					+ solution.getExamId() + " problem ID为: "
//					+ solution.getProblemId() + "代码提交成功");
//			j.setSuccess(true);
//			j.setObj(solution);
//			j.setMsg("代码提交成功");
//
